  ...
  return (
    <section className="xs:px-8 relative mb-12 overflow-hidden px-4 pt-28 sm:px-12 md:px-20 lg:px-28 xl:px-40">
      ...
      <p className={className.p}>
        This Privacy Policy governs the manner in which Tablio Start manages the privacy of users (each, a
        &quot;User&quot;) of the Tablio Start website (&quot;Website&quot;). This privacy policy applies to the Website
        and all products and services offered by Tablio Start.
      </p>
      ...
      <p className={className.p}>
        ...
        identified or identifiable living individual. However, it&apos;s important to note that Tablio Start does not
      ...
      <p className={className.p}>
        Tablio Start does not collect personal or non-personal identification information from Users. Our policy ensures
      ...
      <p className={className.p}>Tablio Start does not request or collect any data directly from Users.</p>
      ...
      <p className={className.p}>
        Since Tablio Start does not collect information from Users, there is no usage of personal information for
        improving the Website, sending periodic emails, or any other purpose.
      </p>

      <h3 className={className.h3}>Payment Processing</h3>
      <p className={className.p}>
        Tablio Start does not collect, process, or use any billing information as no data is collected from our Users.
      </p>

      <h3 className={className.h3}>How we protect your information</h3>
      <p className={className.p}>
        Given that Tablio Start does not collect or store any User data, the question of data protection in the
        traditional sense does not apply.
      </p>

      <h3 className={className.h3}>Sharing your personal information</h3>
      <p className={className.p}>
        Tablio Start does not sell, trade, or rent Users&apos; personal identification information to others as no such
      ...
      <p className={className.p}>
        ...
        collected from their children online. Tablio Start adheres to the principles of COPPA, emphasizing that no
      ...
      <p className={className.p}>
        Tablio Start reserves the right to update this privacy policy at any time. Such changes will be made public on our
